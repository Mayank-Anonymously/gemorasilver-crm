...
export default function Editor() {
  ...
  return (
    <RootStyle title="Components: Editor | Asfiya_Art_Shop">
      <Box
        sx={{
          pt: 6,
          pb: 1,
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3} sx={{ height: 1 }}>
              <Card
                sx={{ height: 1, boxShadow: 0, bgcolor: "background.neutral" }}
              >
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3} sx={{ height: 1 }}>
              ...
              >
                <CardHeader title="Preview Html" />
                <Typography sx={{ p: 3 }}>
                  {draftToHtml(convertToRaw(draftSimple.getCurrentContent()))}
                </Typography>
              </Card>
            </Stack>
          </Grid>
