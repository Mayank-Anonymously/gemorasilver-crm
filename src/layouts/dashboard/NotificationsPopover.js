...
const TITLES = ['Booking is placed', 'Wallet Recharged', 'Refunded Amount', 'Pending Approval', 'Booking Made'];

const DESCRIPTIONS = ['PNR is generated', 'With Min Balance', 'Of 35,900 to account', 'From Customer', 'PNR Pending'];

const TYPES = ['order_placed', 'friend_interactive', 'mail', 'order_shipped'];
