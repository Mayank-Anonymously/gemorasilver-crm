	...
	return useRoutes([
		...
		// Dashboard Routes
		{
			...
			children: [
				...
				{ path: 'add-sub-category', element: <Add_Sub_Category /> },
...
const CreateCategory = Loadable(
	lazy(() => import('../pages/dashboard-one/Product/AddCategory'))
);
const CreateProduct = Loadable(
	lazy(() => import('../pages/dashboard-one/Product/AddProduct'))
);
const View_Category = Loadable(
	lazy(() => import('../pages/dashboard-one/Product/ViewCategory'))
);
const Add_Sub_Category = Loadable(
	lazy(() => import('../pages/dashboard-one/Product/AddSubCategory'))
);
const View_Product = Loadable(
	lazy(() => import('../pages/dashboard-one/Product/ViewProduct'))
);
...
const Color = Loadable(
	lazy(() =>
		import('../pages/components-overview/foundations/FoundationColors')
	)
);
